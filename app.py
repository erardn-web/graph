...
if st.session_state.page == "accueil":
    ...
    with col1:
        ...
        st.write("Analyse des liquidités, des délais par assureur et des retards.")
    ...
    with col2:
        ...
        st.write("Analyse du CA par médecin, tendances et fusion intelligente.")
    ...
    with col3:
        ...
        st.write("Analyse des revenus mensuels par métier et prestations.")
